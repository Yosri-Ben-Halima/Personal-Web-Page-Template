...
<div class="contact-box">
    <h4>About Me</h4>
    <p class="summary">I am a Quant at <a href="https://laevitas.ch/" target="_blank">LAEVITAS</a> and Multidisciplinary Engineer with a passion for Data Science, AI, and Quantitative Finance. My academic and professional journey has been centered around turning raw data into meaningful insights and solutions. I am constantly exploring new technologies and methodologies to enhance my skillset and stay at the forefront of the field.</p>
